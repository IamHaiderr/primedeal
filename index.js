...
var UsersData = require('./modals/Register')
...
//API for fetching level element from mongo db
app.get('/api/v1/userData/:id' , async (req,res) => {
    let data = await UsersData.findById(req.params.id)
